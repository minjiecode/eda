...
ggplot(data = subset(wine, (sulphates<= 1.5)&(volatile.acidity <=1.4)), 
       aes(x = volatile.acidity, y = sulphates, colour = quality.group)) + 
  geom_point(shape = 15, alpha = 0.75) + 
  scale_colour_brewer(palette = "Blues") +
  theme(panel.background = element_rect(fill = "grey20"),
        panel.grid =element_line(linetype = "dotted"))
...
p1 <- ggplot(data = wine, aes(x = density, y = fixed.acidity, 
                        colour = quality.group)) + 
  geom_point(shape = 15, alpha = 0.75) + 
...
p2 <- ggplot(data = wine, aes(x = density, y = volatile.acidity, 
                        colour = quality.group)) + 
  geom_point(shape = 15, alpha = 0.75) + 
  scale_colour_brewer(palette = "Purples") +
  theme(panel.background = element_rect(fill = "grey20"),
...
p3 <- ggplot(data = wine, aes(x = density, y = citric.acid, 
                        colour = quality.group)) + 
  geom_point(shape = 15, alpha = 0.75) + 
  scale_colour_brewer(palette = "Blues") +
  theme(panel.background = element_rect(fill = "grey20"),
...
```{r echo = FALSE}
# citric.acid & density
ggplot(data = wine, aes(x = citric.acid, y = density, 
                        colour = quality.group)) + 
  geom_point(shape = 15, alpha = 0.75) + 
  scale_colour_brewer(palette = "Blues") +
  theme(panel.background = element_rect(fill = "grey20"),
...
```{r echo = FALSE}
# volatile.acidity & fixed.acidity
ggplot(data = subset(wine, citric.acid >0), aes(x = volatile.acidity, y = sqrt(fixed.acidity*citric.acid), colour = quality.group)) + 
  geom_point(shape = 15, alpha = 0.75) + 
  scale_colour_brewer(palette = "Greens") +
  theme(panel.background = element_rect(fill = "grey15"),
        panel.grid =element_line(linetype = "dotted"))
...
ggplot(data = subset(wine, volatile.acidity <=1.4), 
       aes(x = volatile.acidity, y = alcohol, colour = quality.group)) +
  geom_point(alpha = 0.75, shape = 15) +
  scale_colour_brewer(palette = "PuRd") +
  theme(panel.background = element_rect(fill = "grey20"),
        panel.grid =element_line(linetype = "dotted"))
...
p1 <- ggplot(data = wine, aes(factor(quality), volatile.acidity)) + geom_boxplot() +
...
p2 <- ggplot(wine, aes(volatile.acidity, ..density.., colour = quality.group)) +
  geom_freqpoly(binwidth = 0.1) +
  scale_x_continuous(breaks = seq(0.0,1.8, 0.1), 
                     name = "Volatile.acidity (g/dm^3)" )+
  scale_colour_brewer(palette = "Oranges", name = "Quality") +
  theme(panel.background = element_rect(fill = "grey15"),
...
p1 <- ggplot(data = wine, aes(x = density, y = fixed.acidity, 
  ...
  theme(panel.background = element_rect(fill = "grey20"),
        panel.grid =element_line(linetype = "dotted")) + 
  ggtitle("Scatter Plot of Fixed.acidity vs. Density by quality groups")

p2 <- ggplot(data = wine, aes(x = density, y = citric.acid, 
                        colour = quality.group)) + 
  geom_point(shape = 15, alpha = 0.75) + 
  scale_colour_brewer(palette = "Blues") +
  ...
  theme(panel.background = element_rect(fill = "grey20"),
        panel.grid =element_line(linetype = "dotted"))+ 
  ggtitle("Scatter Plot of Citric.acid vs. Density by quality groups")

p3 <- ggplot(data = wine, aes(x = density, y = volatile.acidity, 
                        colour = quality.group)) + 
  geom_point(shape = 15, alpha = 0.75) + 
  scale_colour_brewer(palette = "Purples") +
    scale_y_continuous(name = "Volatile.acidity(g/dm^3)") +
  ...
  theme(panel.background = element_rect(fill = "grey20"),
        panel.grid =element_line(linetype = "dotted"))+ 
  ggtitle("Scatter Plot of Volatile.acidity vs. Density by quality groups")
